...
import { folderStructurePath, baseURL, devKey } from "../../Util/ServerPath";
...
const MovieDialog = (props) => {
  ...
  const fetchData = async () => {
    if (dialogData?.convertUpdateType?.thumbnail === 1) {
    ...
    if (dialogData?.convertUpdateType?.image === 1) {
                              ...
                              <div class="my-3">
                                ...
                                {videoType == 7 && (
                                  <>
                                    ...
                                    {
                                      loading ?
                                       <div style={{marginTop:"30px"}}> <VideoLoader /></div>
                                        :
                                        videoPath && (
                                          <>
                                            <video
